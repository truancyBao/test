  ...
  <div class="page">
    <div class="page-header">
      <a-page-header
        ...
        sub-title="最近考试负责监考的安排"
        title="监考安排"
      />
    </div>
    <a-table :columns="columns" :data-source="taskInfo" :pagination="this.Common.paginationProps">
...
export default {
  ...
  methods: {
    ...
    async getRecords () {
      ...
      return this.$message.success('获取任务成功')
    }
  },
  mounted () {
    this.getRecords()
